...
var s=require('@stdlib/assert-is-collection/dist'),o=require('@stdlib/array-dtypes/dist'),v=require('@stdlib/array-dtype/dist'),d=require('@stdlib/array-base-assert-contains/dist'),l=require('@stdlib/array-base-join/dist'),m=require('@stdlib/stats-strided-max/dist').ndarray,a=require('@stdlib/error-tools-fmtprodmsg/dist'),t=o("real_and_generic"),c="generic";function g(e){var r;if(!s(e))throw new TypeError(a('2EZ2O',e));if(r=v(e)||c,!d(t,r))throw new TypeError(a('2EZHZ',l(t,'", "'),r));return m(e.length,e,1,0)}i.exports=g
